      ...
      <div className="sky-footer-top">
        <div className="sky-footer-col">
          <div className="sky-logo-row">
            <img src="/assets/social/logo_social.png" alt="SKYED" className="sky-logo-icon" />
            <div className="sky-logo-text">SKY<span>ED</span></div>
          </div>
          <p className="sky-tagline">La plataforma profesional para eventos sociales en Boyacá.</p>
          <div className="sky-social-row">
            ...
            <a className="sky-social-btn" href="https://www.whatsapp.com/" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">WA</a>
          </div>
        </div>
        ...
        <div className="sky-footer-col">
          ...
          <ul className="sky-contact-list">
            <li className="sky-contact-item">
              ...
              <div className="sky-contact-text"><strong>Email</strong>skyedsocial@gmail.com</div>
            </li>
            <li className="sky-contact-item">
              <div className="sky-contact-icon"><i className="ti ti-phone" /></div>
              <div className="sky-contact-text"><strong>Teléfono</strong>+57 317 703 7517</div>
            </li>
            <li className="sky-contact-item">
